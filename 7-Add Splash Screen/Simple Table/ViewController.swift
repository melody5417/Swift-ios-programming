...
/*
设置splash screen一直不成功， 然后新建了一个project，进行inspector对比 发现
问题在inspector中一个属性 is initial view controller 勾选它然后
launchScreen.storyboard就出现了entry point 启动时就出现了splash screen。
*/
